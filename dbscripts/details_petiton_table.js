...
con.connect(function(err) {
  ...
  var sql = "CREATE TABLE details_petition (PetID int, FOREIGN KEY (PetID) REFERENCES petitions(PetitionID) ON DELETE CASCADE, Destination VARCHAR(50), EndDate Date, FullDescription VARCHAR(5000))";
