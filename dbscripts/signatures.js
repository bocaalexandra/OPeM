...
con.connect(function(err) {
  ...
  var sql = "CREATE TABLE signatures (PetID int, FOREIGN KEY (PetID) REFERENCES petitions(PetitionID) ON DELETE CASCADE, UserID int, FOREIGN KEY (UserID) REFERENCES users_data(ID), Date DATE, Location VARCHAR(1000))";
