...
con.connect(function(err) {
  ...
  var sql = "CREATE TABLE petitions (PetitionID int PRIMARY KEY NOT NULL AUTO_INCREMENT, UserID int, FOREIGN KEY (UserID) REFERENCES users_data(ID) ON DELETE CASCADE, Date DATE, Title VARCHAR(200), Description VARCHAR(3000))";
