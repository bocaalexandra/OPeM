...
con.connect(function(err) {
  ...
  con.query(sql, function (err, result) {
   ...
   con.query("INSERT INTO users_data (FirstName,LastName,Email,DateOfBirth,PhoneNumber) values ('Poiana','Matei','poianamatei@gmail.com','1989-11-18','0748982356')", function (err, result, fields) {
   if (err) throw err;
   console.log(result);
   });
